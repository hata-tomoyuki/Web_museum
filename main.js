...
function onTouchStart(event) {
  ...
  // タッチ開始位置
  let touched_pos= new THREE.Vector2();

  touched_pos.x = event.changedTouches[0].pageX - (window.innerWidth / 2);
  touched_pos.y = - (event.changedTouches[0].pageY - (window.innerHeight / 2));
